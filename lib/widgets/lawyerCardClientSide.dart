    ...
    return GestureDetector(
      ...
      child: Card(
        ...
        shape: RoundedRectangleBorder(
          borderRadius:
              BorderRadius.circular(15), // Soften edges with rounded corners
        ),
          ...
          child: Row(
            children: [
              CircleAvatar(
                ...
                backgroundColor:
                    Colors.blue[200], // Use a lighter shade of blue
                child: Text(
                  'image',
                  style: TextStyle(
                      color: Colors.blue[800]), // Darker text for contrast
                ),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      lawyer.domain,
                      style: TextStyle(
                          color: Colors.grey), // Use grey for less emphasis
                    ),
                    SizedBox(height: 5),
                    Text(
